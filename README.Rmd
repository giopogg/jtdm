...
### R-package
The package implements jtdm using the Markov Chain Monte Carlo Bayesian modeling software JAGS via the R package runjags. Therefore, it requires the installation of JAGS.
...
Computes joint probabilities of both SLA and LNC to be greater than 20 in a high altitude site.
```{r}
